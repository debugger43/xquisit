  ...
  return (
    <div className="relative min-h-screen bg-[#111111] text-[#f7f2eb] font-sans overflow-x-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none opacity-40 lg:opacity-80" aria-hidden="true">
        ...
        <div className="absolute bottom-[27%] left-[1%] w-[350px] h-[200px] flex items-center justify-center">
          <img src="/images/Video Player.png" alt="" />
        </div>
        <div className="absolute bottom-[25%] left-[15%] w-12 h-12 rounded-full border-2 border-pink-500" />
        <div className="absolute bottom-[25%] right-[5%] w-[50px] h-[50px] flex items-center justify-center">
          <img src="/images/Vector.png" alt="" />
        </div>
        <div className="absolute bottom-[10%] right-[0%] w-[300px] h-[200px] flex items-center justify-center">
